...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PhotoAssessmentKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// \param block completion block
///
- (void)edgeDetectOfImagePixels:(NSArray<NSNumber *> * _Nonnull)imagePixels width:(NSInteger)width height:(NSInteger)height completionHandler:(void (^ _Nonnull)(int8_t, int8_t))block;
- (void)meanSaturationOfImagePixels:(NSArray<NSNumber *> * _Nonnull)imagePixels width:(NSInteger)width height:(NSInteger)height completionHandler:(void (^ _Nonnull)(float))block;
- (void)fingerprintOfImagePixels:(NSArray<NSNumber *> * _Nonnull)imagePixels width:(NSInteger)width height:(NSInteger)height completionHandler:(void (^ _Nonnull)(NSDictionary<NSNumber *, NSNumber *> * _Nullable))block;
@end
